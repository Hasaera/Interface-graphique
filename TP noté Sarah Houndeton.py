...
class Fichier(Noeud):
    def __init__(self, identifiant_unique: int, nom: str, droits_acces: str, lecteur: None):
...
if __name__ == '__main__':
    ...
    FichierDoc1 = FichierDoc(4, "APP", "read", LecteurDocument())
    Peripherique1 = Peripherique(5, "Cours POO", "read", True)
    Image1 = Image(7, "Java", "read", LecteurDocument())
    Fichier2 = Fichier(8, "Cours ", "read", LecteurDocument())
